...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getRouterParam, setHeader, getQuery as getQuery$1, getRequestWebStream, getResponseStatus, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file://D:/development/my-blog/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/development/my-blog/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///D:/development/my-blog/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///D:/development/my-blog/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://D:/development/my-blog/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/development/my-blog/node_modules/unhead/dist/server.mjs';
import { isVNode, isRef, toValue } from 'file://D:/development/my-blog/node_modules/vue/index.mjs';
import { DeprecationsPlugin } from 'file://D:/development/my-blog/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/development/my-blog/node_modules/unhead/dist/plugins.mjs';
import { klona } from 'file://D:/development/my-blog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/development/my-blog/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/development/my-blog/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/development/my-blog/node_modules/scule/dist/index.mjs';
import { defineDiagnostics, createConsoleReporter } from 'file://D:/development/my-blog/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://D:/development/my-blog/node_modules/nostics/dist/formatters/ansi.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/development/my-blog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file://D:/development/my-blog/node_modules/vue/server-renderer/index.mjs';
import { stringify, uneval } from 'file://D:/development/my-blog/node_modules/devalue/index.js';
import { createHooks } from 'file://D:/development/my-blog/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/development/my-blog/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/development/my-blog/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/development/my-blog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/development/my-blog/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://D:/development/my-blog/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/development/my-blog/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/development/my-blog/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/development/my-blog/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/development/my-blog/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/development/my-blog/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/development/my-blog/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/development/my-blog/node_modules/errx/dist/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://D:/development/my-blog/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file://D:/development/my-blog/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://D:/development/my-blog/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file://D:/development/my-blog/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/development/my-blog/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/development/my-blog","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/development/my-blog/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/development/my-blog/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/development/my-blog/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/development/my-blog/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "D:/development/my-blog/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _f5uBEiIcJ6IwHqdnBB_EZdP2r6gHrwlmnXTgbWDo0Os = (function(nitro) {
...
const rootDir = "D:/development/my-blog";
...
const plugins = [
  _f5uBEiIcJ6IwHqdnBB_EZdP2r6gHrwlmnXTgbWDo0Os,
...
const _sRqc5e = eventHandler((event) => {
...
const _uxEjXY = eventHandler(async (event) => {
  ...
  return await import('file://D:/development/my-blog/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const checksums = {
  "content": "v3.5.0--QG9516f3_CN30kEJZfVhcLE2o3tj-z1FQaW6FSuBPTQ"
};
...
const _1N2CRF = eventHandler(async (event) => {
...
const _lazy_hjAYHC = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _sRqc5e, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_hjAYHC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _uxEjXY, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _uxEjXY, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _1N2CRF, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _1N2CRF, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_hjAYHC, lazy: true, middleware: false, method: undefined }
];
