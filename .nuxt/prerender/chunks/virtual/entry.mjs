import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineProdDiagnostics } from 'file://D:/development/my-blog/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://D:/development/my-blog/node_modules/nostics/dist/formatters/ansi.mjs';
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, shallowReactive, reactive, effectScope, hasInjectionContext, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, inject, defineAsyncComponent, mergeProps, toRef, shallowRef, isReadonly, defineComponent, h, useSSRContext, isRef, isShallow, isReactive, toRaw, isVNode, createCommentVNode, withCtx, createTextVNode, Suspense, resolveComponent, Fragment, computed } from 'file://D:/development/my-blog/node_modules/vue/index.mjs';
import { createHooks } from 'file://D:/development/my-blog/node_modules/nuxt/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://D:/development/my-blog/node_modules/unctx/dist/index.mjs';
import { createError, appendHeader, sanitizeStatusCode } from 'file://D:/development/my-blog/node_modules/h3/dist/index.mjs';
import { joinURL, hasProtocol, withQuery, parseURL, encodePath, decodePath, parseQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash } from 'file://D:/development/my-blog/node_modules/ufo/dist/index.mjs';
import { $fetch } from 'file://D:/development/my-blog/node_modules/ofetch/dist/node.mjs';
import { e as baseURL } from '../_/nitro.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, RouterView } from 'file://D:/development/my-blog/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://D:/development/my-blog/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate } from 'file://D:/development/my-blog/node_modules/vue/server-renderer/index.mjs';
...
var virtual_nuxt__nuxt_2Froutes_default = [
	{
		name: "artworks",
		path: "/artworks",
		component: () => import('../build/artworks-iKiMzGQ_.mjs')
	},
	{
		name: "posts",
		path: "/posts",
		component: () => import('../build/posts-CYEUYlzS.mjs')
	},
	{
		name: "slug",
		path: "/:slug(.*)*",
		component: () => import('../build/_...slug_-CEnvPqRQ.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-CBszMMXa.mjs')
	}
];
//#endregion
...
var ProseA_default = defineAsyncComponent(() => import('../build/ProseA-BL4SEFU3.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseBlockquote_default = defineAsyncComponent(() => import('../build/ProseBlockquote-UhkQulYo.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseCode_default = defineAsyncComponent(() => import('../build/ProseCode-BYiav7Hk.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseEm_default = defineAsyncComponent(() => import('../build/ProseEm-DPjdyycl.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH1_default = defineAsyncComponent(() => import('../build/ProseH1-pcQQ02hk.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH2_default = defineAsyncComponent(() => import('../build/ProseH2-DsswfhSI.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH3_default = defineAsyncComponent(() => import('../build/ProseH3-CaG2r2IL.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH4_default = defineAsyncComponent(() => import('../build/ProseH4-DtFYW9Ow.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH5_default = defineAsyncComponent(() => import('../build/ProseH5-XIsshA4y.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH6_default = defineAsyncComponent(() => import('../build/ProseH6-COUSAYiW.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseHr_default = defineAsyncComponent(() => import('../build/ProseHr-CrIoccAs.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseImg_default = defineAsyncComponent(() => import('../build/ProseImg-BnAeDu7O.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseLi_default = defineAsyncComponent(() => import('../build/ProseLi-C5NqAxv7.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseOl_default = defineAsyncComponent(() => import('../build/ProseOl-D2xdBq8O.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseP_default = defineAsyncComponent(() => import('../build/ProseP-BschMuxe.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProsePre_default = defineAsyncComponent(() => import('../build/ProsePre-D3dmosj4.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseScript_default = defineAsyncComponent(() => import('../build/ProseScript-CrMcIRJy.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseStrong_default = defineAsyncComponent(() => import('../build/ProseStrong-DmaBy62M.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTable_default = defineAsyncComponent(() => import('../build/ProseTable-CtovSIaO.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTbody_default = defineAsyncComponent(() => import('../build/ProseTbody-DYFoy_Ov.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTd_default = defineAsyncComponent(() => import('../build/ProseTd-C1lGqNfQ.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTh_default = defineAsyncComponent(() => import('../build/ProseTh-CcEsqnX7.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseThead_default = defineAsyncComponent(() => import('../build/ProseThead-CfibruOi.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTr_default = defineAsyncComponent(() => import('../build/ProseTr-DeLFqxUK.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseUl_default = defineAsyncComponent(() => import('../build/ProseUl-DthvL2lU.mjs').then((r) => r["default"] || r.default || r));
//#endregion
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
	...
	_push(`<div${ssrRenderAttrs(mergeProps({ class: "site-shell" }, _attrs))}><header class="site-header">`);
	_push(ssrRenderComponent(_component_NuxtLink, {
		to: "/",
		class: "brand"
	}, {
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) _push(`Midnight Notes`);
			else return [createTextVNode("Midnight Notes")];
		}),
		_: 1
	}, _parent));
	_push(`<nav>`);
	_push(ssrRenderComponent(_component_NuxtLink, { to: "/posts" }, {
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) _push(`文章`);
			else return [createTextVNode("文章")];
		}),
		_: 1
	}, _parent));
	_push(ssrRenderComponent(_component_NuxtLink, { to: "/artworks" }, {
		default: withCtx((_, _push, _parent, _scopeId) => {
			if (_push) _push(`画作`);
			else return [createTextVNode("画作")];
		}),
		_: 1
	}, _parent));
	...
	_push(`</main><footer>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} · 用文字与线条记录生活</footer></div>`);
}
...
export { NuxtLink as N, _plugin_vue_export_helper_default as _, useRuntimeConfig as a, appDiagnostics as b, createError$1 as c, useNuxtApp as d, asyncDataDefaults as e, docsBase as f, useHead$1 as g, entry as h, prodReporters as p, sanitizeTag as s, tryUseNuxtApp as t, useRoute$1 as u };
