import { mergeProps, useSSRContext } from 'file://D:/development/my-blog/node_modules/vue/index.mjs';
...
var _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<pre${ssrRenderAttrs(mergeProps({ class: _ctx.$props.class }, _attrs))}>`);
...
//# sourceMappingURL=ProsePre-D3dmosj4.mjs.map
