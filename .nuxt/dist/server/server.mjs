import { a as useNuxtApp, c as nuxtLinkDefaults, d as docsBase, f as prodReporters, n as createNuxtApp, o as useRuntimeConfig, r as defineNuxtPlugin, t as applyPlugins } from "./_nuxt/nuxt-RsUFM4iI.js";
import { defineProdDiagnostics } from "nostics";
import { Fragment, Suspense, computed, createApp, createCommentVNode, createTextVNode, createVNode, defineAsyncComponent, defineComponent, getCurrentInstance, getCurrentScope, h, hasInjectionContext, inject, isReactive, isReadonly, isRef, isShallow, isVNode, mergeProps, onErrorCaptured, onServerPrefetch, provide, reactive, ref, resolveComponent, resolveDynamicComponent, shallowReactive, shallowRef, toRaw, toRef, unref, useSSRContext, withCtx } from "vue";
import { executeAsync } from "D:/development/my-blog/node_modules/unctx/dist/index.mjs";
import { appendHeader, createError, sanitizeStatusCode } from "D:/development/my-blog/node_modules/@nuxt/nitro-server/dist/h3.mjs";
import { decodePath, encodePath, hasProtocol, isScriptProtocol, joinURL, parseQuery, parseURL, withQuery, withTrailingSlash, withoutTrailingSlash } from "D:/development/my-blog/node_modules/ufo/dist/index.mjs";
import { $fetch } from "D:/development/my-blog/node_modules/ofetch/dist/node.mjs";
...
import { defu } from "D:/development/my-blog/node_modules/defu/dist/defu.mjs";
import { headSymbol, useHead } from "D:/development/my-blog/node_modules/@unhead/vue/dist/index.mjs";
import { ssrInterpolate, ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
var virtual_nuxt__nuxt_2Froutes_default = [
	{
		name: "artworks",
		path: "/artworks",
		component: () => import("./_nuxt/artworks-iKiMzGQ_.js")
	},
	{
		name: "posts",
		path: "/posts",
		component: () => import("./_nuxt/posts-CYEUYlzS.js")
	},
	{
		name: "slug",
		path: "/:slug(.*)*",
		component: () => import("./_nuxt/_...slug_-CEnvPqRQ.js")
	},
	{
		name: "index",
		path: "/",
		component: () => import("./_nuxt/pages-CBszMMXa.js")
	}
];
//#endregion
...
var ProseA_default = defineAsyncComponent(() => import("./_nuxt/ProseA-BL4SEFU3.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseBlockquote_default = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-UhkQulYo.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseCode_default = defineAsyncComponent(() => import("./_nuxt/ProseCode-BYiav7Hk.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseEm_default = defineAsyncComponent(() => import("./_nuxt/ProseEm-DPjdyycl.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH1_default = defineAsyncComponent(() => import("./_nuxt/ProseH1-pcQQ02hk.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH2_default = defineAsyncComponent(() => import("./_nuxt/ProseH2-DsswfhSI.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH3_default = defineAsyncComponent(() => import("./_nuxt/ProseH3-CaG2r2IL.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH4_default = defineAsyncComponent(() => import("./_nuxt/ProseH4-DtFYW9Ow.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH5_default = defineAsyncComponent(() => import("./_nuxt/ProseH5-XIsshA4y.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseH6_default = defineAsyncComponent(() => import("./_nuxt/ProseH6-COUSAYiW.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseHr_default = defineAsyncComponent(() => import("./_nuxt/ProseHr-CrIoccAs.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseImg_default = defineAsyncComponent(() => import("./_nuxt/ProseImg-BnAeDu7O.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseLi_default = defineAsyncComponent(() => import("./_nuxt/ProseLi-C5NqAxv7.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseOl_default = defineAsyncComponent(() => import("./_nuxt/ProseOl-D2xdBq8O.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseP_default = defineAsyncComponent(() => import("./_nuxt/ProseP-BschMuxe.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProsePre_default = defineAsyncComponent(() => import("./_nuxt/ProsePre-D3dmosj4.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseScript_default = defineAsyncComponent(() => import("./_nuxt/ProseScript-CrMcIRJy.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseStrong_default = defineAsyncComponent(() => import("./_nuxt/ProseStrong-DmaBy62M.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTable_default = defineAsyncComponent(() => import("./_nuxt/ProseTable-CtovSIaO.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTbody_default = defineAsyncComponent(() => import("./_nuxt/ProseTbody-DYFoy_Ov.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTd_default = defineAsyncComponent(() => import("./_nuxt/ProseTd-C1lGqNfQ.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTh_default = defineAsyncComponent(() => import("./_nuxt/ProseTh-CcEsqnX7.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseThead_default = defineAsyncComponent(() => import("./_nuxt/ProseThead-CfibruOi.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseTr_default = defineAsyncComponent(() => import("./_nuxt/ProseTr-DeLFqxUK.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var ProseUl_default = defineAsyncComponent(() => import("./_nuxt/ProseUl-DthvL2lU.js").then((r) => r["default"] || r.default || r));
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-zRu_VwMh.js"));
		const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BA-ElgYO.js"));
...
//#endregion
export { createError$1 as a, entry_default as default, sanitizeTag as i, NuxtLink as n, useRoute$1 as o, useHead$1 as r, _plugin_vue_export_helper_default as t };
